  ...
  <!--  Main Banner  -->
  <div class="banner-service"><div class="container"></div></div>
  <!--  Main Banner  -->
            ...
            <div class="accordion mb-5" id="accordionExample">
              <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body text-center">
                    <nav class="nav nav-pills flex-column">
                      <a class="nav-link ms-3 my-1" href="#item-1-1" onclick="showDetails('aktaPendirian', 'collapseOne')">AKTA PENDIRIAN PT</a>
                      <a class="nav-link ms-3 my-1" href="#item-1-2" onclick="showDetails('aktaPerseroan', 'collapseOne')">AKTA PERSEROAN KOMANDITER (CV)</a>
                      <a class="nav-link ms-3 my-1" href="#item-1-2" onclick="showDetails('aktaYayasan', 'collapseOne')">AKTA YAYASAN</a>
                      <a class="nav-link ms-3 my-1" href="#item-1-2" onclick="showDetails('aktaPerkumpulan', 'collapseOne')">AKTA PERKUMPULAN</a>
                      <a class="nav-link ms-3 my-1" href="#item-1-2" onclick="showDetails('aktaPerjanjianPerorangan', 'collapseOne')">AKTA PERJANJIAN KERJASAMA PERORANGAN</a>
                      <a class="nav-link ms-3 my-1" href="#item-1-2" onclick="showDetails('aktaPerjanjianPerusahaan', 'collapseOne')">AKTA PERJANJIAN KERJASAMA PERUSAHAAN</a>
                      <a class="nav-link ms-3 my-1" href="#item-1-2" onclick="showDetails('perjanjianKawin', 'collapseOne')">PERJANJIAN KAWIN</a>
                      <a class="nav-link ms-3 my-1" href="#item-1-2" onclick="showDetails('aktaPengakuanHutang', 'collapseOne')">AKTA PENGAKUAN HUTANG / PEMBIAYAAN</a>
                      <a class="nav-link ms-3 my-1" href="#item-1-2" onclick="showDetails('cessie', 'collapseOne')">CESSIE</a>
                      <a class="nav-link ms-3 my-1" href="#item-1-2" onclick="showDetails('fidusia', 'collapseOne')">FIDUSIA</a>
                    </nav>
                  </div>
                </div>
              ...
              <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body text-center">
                    <nav class="nav nav-pills flex-column">
                      <a class="nav-link ms-3 my-1" href="#item-2-1" onclick="showDetails('akteJualBeli', 'collapseTwo')">AKTA JUAL BELI</a>
                      <a class="nav-link ms-3 my-1" href="#item-2-2" onclick="showDetails('akteHibah', 'collapseTwo')">AKTA HIBAH</a>
                      <a class="nav-link ms-3 my-1" href="#item-2-3" onclick="showDetails('akteHakBersama', 'collapseTwo')">AKTA PEMBAGIAN HAK BERSAMA</a>
                      <a class="nav-link ms-3 my-1" href="#item-2-4" onclick="showDetails('akteWaris', 'collapseTwo')">AKTA WARIS</a>
                      <a class="nav-link ms-3 my-1" href="#item-2-5" onclick="showDetails('akteBalikNamaWaris', 'collapseTwo')">AKTA BALIK NAMA WARIS</a>
                      <a class="nav-link ms-3 my-1" href="#item-2-6" onclick="showDetails('akteSKMHT', 'collapseTwo')">AKTA SKMHT</a>
                      <a class="nav-link ms-3 my-1" href="#item-2-7" onclick="showDetails('akteAPHT', 'collapseTwo')">AKTA APHT</a>
                    </nav>
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body text-center">
                    <nav class="nav nav-pills flex-column">
                      <a class="nav-link ms-3 my-1" href="#item-3-1" onclick="showDetails('pengecekanSertifikat', 'collapseThree')">PENGECEKAN SERTIFIKAT</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-2" onclick="showDetails('roya', 'collapseThree')">ROYA</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-3" onclick="showDetails('peningkatanHakMilik', 'collapseThree')">PENINGKATAN HAK MILIK RUMAH / RUKO</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-4" onclick="showDetails('legalisasi', 'collapseThree')">LEGALISASI</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-5" onclick="showDetails('warmerking', 'collapseThree')">WARMERKING</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-6" onclick="showDetails('fotocopyAsli', 'collapseThree')">FOTOCOPY SESUAI ASLI</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-7" onclick="showDetails('sertifikasi', 'collapseThree')">SERTIFIKASI</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-8" onclick="showDetails('penerbitanSertifikat', 'collapseThree')">PENERRBITAN SERTIFIKAT PENGGANTI</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-9" onclick="showDetails('penurunanHak', 'collapseThree')">PENURUNAN HAK</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-10" onclick="showDetails('perijinanPertanahan', 'collapseThree')">PERIJINAN PERTANAHAN</a>
                      <a class="nav-link ms-3 my-1" href="#item-3-1" onclick="showDetails('pengurusanPerpajakan', 'collapseThree')">PENGURUSAN PERPAJAKAN</a>
                    </nav>
                  </div>
                </div>
              </div>
      ...
      <div class="col-lg-8 col-md-6 col-sm-2 text-center py-3 ">
        <div class="content">
          ...
          <div id="pengecekanSertifikat" class="details-service">
            ...
            <p>Pengecekan sertifikat merujuk pada proses verifikasi atau validasi keaslian dan keabsahan sertifikat yang dikeluarkan oleh lembaga tertentu. Sertifikat ini bisa berupa sertifikat akademik, sertifikat kompetensi, sertifikat pelatihan, atau sertifikat keahlian lainnya.</p>
          </div>
          <div id="roya" class="details-service">
            <h4>ROYA</h4>
            <p>ROYA adalah layanan yang disediakan oleh kantor pertanahan atau badan yang berwenang untuk memproses penghapusan hak tanggungan atas suatu aset atau properti setelah utang atau pinjaman yang dijamin telah dilunasi. Layanan ini penting untuk memastikan bahwa hak tanggungan yang melekat pada sertifikat tanah atau properti dihapus secara resmi dan tercatat dalam sistem pertanahan.</p>
          </div>
          <div id="peningkatanHakMilik" class="details-service">
            <h4>PENINGKATAN HAK MILIK RUMAH / RUKO</h4>
            <p>Layanan Peningkatan Hak Milik Rumah atau Ruko adalah layanan yang disediakan oleh kantor pertanahan untuk mengubah status atau jenis hak atas tanah dari hak yang lebih rendah menjadi hak milik, yang merupakan hak atas tanah yang tertinggi di Indonesia. Proses ini biasanya dilakukan untuk meningkatkan kepastian hukum dan nilai ekonomis dari properti tersebut.</p>
          </div>
          <div id="legalisasi" class="details-service">
            <h4>LEGALISASI</h4>
            <p>Layanan legalisasi adalah proses pengesahan dokumen yang dilakukan oleh notaris untuk memastikan bahwa dokumen tersebut telah ditandatangani dengan benar oleh pihak yang berwenang dan keasliannya dapat dipercaya. Layanan ini sering kali diperlukan untuk berbagai dokumen hukum, komersial, dan pribadi yang memerlukan bukti tambahan keaslian dan validitas.</p>
          </div>
          <div id="warmerking" class="details-service">
            <h4>WARMERKING</h4>
            <p>Layanan Warmerking adalah layanan yang disediakan oleh notaris untuk menandai atau memberikan tanda pengesahan pada salinan dokumen, yang menunjukkan bahwa salinan tersebut benar-benar sesuai dengan aslinya. Layanan ini sering disebut juga sebagai "waarmerken" dalam bahasa Belanda, yang berarti "memberi tanda" atau "memberi cap pengesahan".</p>
          </div>
          <div id="fotocopyAsli" class="details-service">
            <h4>FOTOCOPY SESUAI ASLI</h4>
            <p>Layanan fotocopy sesuai asli adalah layanan  untuk membuat salinan dokumen yang dinyatakan sebagai salinan yang benar-benar sesuai dengan dokumen aslinya. Proses ini melibatkan verifikasi dan pengesahan bahwa fotokopi tersebut adalah reproduksi yang akurat dari dokumen aslinya.</p>
          </div>
          <div id="sertifikasi" class="details-service">
            <h4>SERTIFIKASI</h4>
            <p>Layanan sertifikasi adalah layanan yang disediakan oleh lembaga atau organisasi yang berwenang untuk memberikan pengakuan resmi bahwa seseorang, produk, sistem, atau proses telah memenuhi standar tertentu yang telah ditetapkan. Proses sertifikasi melibatkan penilaian, verifikasi, dan pengujian untuk memastikan kepatuhan terhadap standar yang relevan.</p>
          </div>
          <div id="penerbitanSertifikat" class="details-service">
            <h4>PENERRBITAN SERTIFIKAT PENGGANTI</h4>
            <p>Layanan penerbitan sertifikat pengganti adalah layanan untuk menerbitkan sertifikat baru sebagai pengganti sertifikat yang asli karena sertifikat asli tersebut hilang, rusak, atau musnah.</p>
          </div>
          <div id="penurunanHak" class="details-service">
            <h4>PENURUNAN HAK</h4>
            <p>Layanan penurunan hak adalah layanan untuk melakukan pengurangan atau penghapusan hak-hak tertentu yang terdapat pada sertifikat tanah atau properti. Proses ini umumnya dilakukan atas permintaan pemilik tanah atau properti untuk mengurangi atau menghapus hak-hak yang tercatat atas properti mereka, seperti hak tanggungan atau hak pakai, yang mungkin membatasi atau mempengaruhi penggunaan atau pemanfaatan properti tersebut.</p>
          </div>
          <div id="perijinanPertanahan" class="details-service">
            <h4>PERIJINAN PERTANAHAN</h4>
            <p>Layanan perijinan pertanahan merujuk pada proses atau layanan yang disediakan untuk memberikan izin atau persetujuan resmi terkait dengan penggunaan atau pemanfaatan lahan atau properti tertentu. Prosedur ini biasanya dilakukan untuk memastikan bahwa penggunaan lahan atau properti tersebut sesuai dengan peraturan dan ketentuan yang berlaku, baik dari segi lingkungan, tata ruang, maupun keamanan.</p>
          </div>
          <div id="pengurusanPerpajakan" class="details-service">
            <h4>PENGURUSAN PERPAJAKAN</h4>
            <p>Layanan pengurusan perpajakan merujuk pada berbagai proses dan kegiatan yang dilakukan untuk memastikan bahwa kewajiban perpajakan sebuah entitas atau individu dipenuhi dengan benar dan tepat waktu. Ini mencakup pengelolaan administrasi perpajakan, penyusunan laporan pajak, pengajuan dokumen, serta pemenuhan semua kewajiban yang terkait dengan peraturan perpajakan yang berlaku..</p>
          </div>
        </div>
      </div>
    </div>
